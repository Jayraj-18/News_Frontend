...
export const HomePage = ({ currentPath = window.location.pathname }) => {
  ...
  return (
    <div className="container mx-auto px-4 mt-6 mb-12">
       <SEO 
              title="पालघर दृष्टी | पालघर जिल्ह्यातील ताज्या मराठी बातम्या"
              description="पालघर जिल्ह्यातील ताज्या आणि विश्वासार्ह मराठी बातम्या वाचा. स्थानिक, राजकारण, शेती, गुन्हेगारी, शिक्षण, क्रीडा, व्यवसाय, तंत्रज्ञान, मनोरंजन आणि देश-विदेशातील ताज्या घडामोडी."
              path="/contact"
